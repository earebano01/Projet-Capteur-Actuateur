...
const int colorR = 255;                    // voici la declaration pour des variable qu'on utilise pour notre
const int colorG = 0;                      // lcd, on declare notre variable pour notre capture de mouvement et
const int colorB = 0;           

const int pirSensor = 2;                   // on utilise la broche numero 2
const int flamme = 3;                      // on utilise la broche numero 3
...
//-----il faut trouver notre code pour initialisation dans partie-----//
    ...
    lcd.setCursor(3, 1);
    lcd.print("BIENVENUE");           // on affiche le nom du client
